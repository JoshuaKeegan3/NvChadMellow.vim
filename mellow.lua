local variants = require("custom.themes.mellow_settings.colours")
local cfg = require("custom.themes.mellow_settings.config").config
...
M.base_30 = {
    white = "#c1c0d4",
    black = "#161617",        -- usually your theme bg
    darker_black = "#131314", -- 6% darker than black
    black2 = "#1b1b1d",       -- 6% lighter than black
    one_bg = "#27272a",       -- 10% lighter than black
    one_bg2 = "#2a2a2d",      -- 6% lighter than one_bg2
    one_bg3 = "#3e3e43",      -- 6% lighter than one_bg3
    grey = "#57575f",         -- 40% lighter than black (the % here depends so choose the perfect grey!)
    grey_fg = "#757581",      -- 10% lighter than grey
    grey_fg2 = "#9998a8",     -- 5% lighter than grey
    light_grey = "#cac9dd",
    red = "#f5a191",
    baby_pink = "#f591b2",
    pink = "#ea83a5",
    line = "#353539", -- 15% lighter than black
    green = "#90b99f",
    vibrant_green = "#9dc6ac",
    nord_blue = "#b9aeda",
    blue = "#aca1cf",
    seablue = "#aca1cf",
    yellow = "#e6b99d", -- 8% lighter than yellow
    sun = "#f0c5a9",
    purple = "#e29eca",
    dark_purple = "#ecaad6",
    teal = "#aca1cf",
...
M.base_16 = {
    ...
    base08 = "#c9c7cd",
    base09 = c.bright_red,
    base0A = c.bright_green,
    base0B = c.bright_yellow,
    base0C = c.bright_blue,
    base0D = c.bright_magenta,
    base0E = c.bright_cyan,
    base0F = c.bright_white,
} -- this will be later used for users to override your theme table from chadrc
M.polish_hl = {
    -- ["Comment"] = { fg = c.gray05, style = cfg.comment_style }, -- any comment
    ["Comment"] = { fg = c.gray05, },                                            -- any comment
...
M = require("base46").override_theme(M, "mellow")
return M
